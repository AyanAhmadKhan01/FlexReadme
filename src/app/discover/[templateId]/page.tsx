...
import { X, Download,Github, Copy, ArrowLeft,  } from "lucide-react"
      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 bg-muted/50 rounded-full flex items-center justify-center mx-auto mb-4">
            <span className="text-2xl text-red-500"><X size={36}/></span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center space-x-2 bg-muted/30 rounded-lg p-1">
              ...
              <img src="https://res.cloudinary.com/dt5qoqw6u/image/upload/v1738516973/gxonvnkg2gyha5phlc0y.jpg" alt="github" />
                  </div>                  

            <div className="bg-card h-fit rounded-lg border border-border p-6">
              <h3 className="font-semibold mb-4">Made By</h3>
