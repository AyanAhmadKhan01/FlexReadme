...
export function BentoCanvas({ 
  ...
  const handleMouseMove = (e: React.MouseEvent) => {
    ...
    if (resizing && canvasRef.current) {
      ...
      const now = Date.now()
      if (now - lastResizeUpdate.current < 16) return // ~60fps
      ...
      // Calculate new size based on start size + delta
  ...
  const renderComponent = (item: BentoItem) => {
    ...
    if (item.useCustomBackground && item.backgroundImage) {
      ...
      switch (item.type) {
        case "header-image":
          backgroundStyle = { backgroundColor: "#1e1b4b" } // Deep purple
          break
        case "badges-image":
          backgroundStyle = { backgroundColor: "#065f46" } // Deep emerald
          break
        case "stats-image":
          backgroundStyle = { backgroundColor: "#164e63" } // Deep cyan
          break
        case "profile-card":
          backgroundStyle = { backgroundColor: "#7c2d12" } // Deep orange
          break
        case "streak-stats":
          backgroundStyle = { backgroundColor: "#991b1b" } // Deep red
          break
        case "trophy-display":
          backgroundStyle = { backgroundColor: "#a16207" } // Deep yellow
          break
        case "contributions":
          backgroundStyle = { backgroundColor: "#14532d" } // Deep green
          break
        case "languages":
          backgroundStyle = { backgroundColor: "#3730a3" } // Deep indigo
          break
        case "recent-activity":
          backgroundStyle = { backgroundColor: "#0f766e" } // Deep teal
          break
        case "visitors-counter":
          backgroundStyle = { backgroundColor: "#374151" } // Deep gray
          break
        case "typing-svg":
          backgroundStyle = { backgroundColor: "#581c87" } // Deep violet
          break
        case "random-quote":
          backgroundStyle = { backgroundColor: "#9f1239" } // Deep pink
          break
        default:
          backgroundStyle = { backgroundColor: "#1f2937" } // Default dark gray
      }
    }
        ...
        return (
          ...
          >
            ...
            >
              ...
              <h3 className={`${textClasses} mb-2 font-semibold`}>{customText || "Typing Animation"}</h3>
              <p className="text-xs opacity-80 font-mono">Animated typing text</p>
          ...
          >
            ...
            >
              <div 
                ...
                style={{ backgroundColor: iconBgColor, borderColor }}
              >
                <MessageSquare className="w-8 h-8" style={{ color: iconColor }} />
              </div>
  ...
  return (
    <div className="relative">
      ...
      {items.length === 0 && (
        <div 
          className="col-span-full row-span-4 flex items-center justify-center text-center border-2 border-dashed border-primary/20 rounded-lg bg-background/80 p-4"
        >
          <div>
            ...
            <Badge variant="outline" className="text-xs">Components are GitHub-compatible images</Badge>
          </div>
        </div>
      )}
